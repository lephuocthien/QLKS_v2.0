...
public class BookDto {
    ...
    public BookDto(int id, int roomId, int userId, Date dateIn, Date dateOut, int count, BigDecimal moneyTra, BigDecimal moneyCon, String cusName, String cusCmnd, String cusPhone, String cusDiaChi, Date cusNgaySinh) {
        this.id = id;
        this.roomId = roomId;
        this.userId = userId;
        this.dateIn = dateIn;
